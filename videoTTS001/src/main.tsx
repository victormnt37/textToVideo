...
const heritagesRuta = [
  {
    ...
    "short_heritage_description": "Open-air auditorium with spectacular night vision.",
  ...
  },
  {
    ...
    "short_heritage_description": "It is a park with a intimate festive tradition in Buñol.",
...
function transformHeritageObject(obj: any) {
  ...
  try {
    ...
    if (Array.isArray(images) && images.length > 0) {
      imageUrl = IMAGE_BASE_URL + images[0];
    }
  } catch {
    imageUrl = IMAGE_BASE_URL + obj.image;
  }

  return {
    id: obj.id, // antes era identifier
    name: obj.name,
    description: {
      local: {
